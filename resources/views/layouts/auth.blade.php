...
<meta property="og:title" content="Разработка web-приложения для ведения проектов">
...
<!-- Favicon -->
<link rel="apple-touch-icon" sizes="120x120" href="{{public_path("\resources\assets\img\favicon\apple-touch-icon.png")}}">
